...
class BatchGenerator(Sequence):
    ...
    def _aug_image(self, instance, net_h, net_w):
        ...
        image = pydicom.dcmread(image_name).pixel_array # RGB image ###
    ...
    def load_image(self, i):
        image = pydicom.dcmread(self.instances[i]['filename']).pixel_array ###
        return np.stack([image,np.zeros_like(image),np.zeros_like(image)],axis=2) ### 