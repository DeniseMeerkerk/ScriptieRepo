...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 19 13:12:03 2022
...
argparser.add_argument(
    ...
    default= '/home/denise/Downloads/IMG_20211014_150240.jpg')
...
#print(type(tf.convert_to_tensor(new_image,dtype=np.float32)))

# run the prediction
yolos = yolov3.predict(new_image)
features_layer92 = Model(inputs=yolov3.inputs,
                         outputs=yolov3.get_layer(name="conv_105").output)


features = features_layer92(tf.convert_to_tensor(new_image,dtype=np.float32))
#%%
boxes = []
...
with tf.Session() as sess:
    ...
    features_out = sess.run(features)
