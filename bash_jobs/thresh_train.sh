...
--input_json /ceph/csedu-scratch/project/dmeerkerk/UI_Xray/json/train_hopefully_final_out_all_patched_thresh.json \
--input_fc_dir /ceph/csedu-scratch/project/dmeerkerk/UI_Xray/bu_out_all_thresh_fc \
--input_att_dir /ceph/csedu-scratch/project/dmeerkerk/UI_Xray/bu_out_all_thresh_att \
...
--input_rel_box_dir /ceph/csedu-scratch/project/dmeerkerk/UI_Xray/bu_out_all_thresh_rel \
--checkpoint_path /ceph/csedu-scratch/project/dmeerkerk/UI_Xray/model/thresh/ \
--label_smoothing 0.0 \
--batch_size 1 \
--learning_rate 5e-4 \
--num_layers 6 \
