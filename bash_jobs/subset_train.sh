...
--input_json /ceph/csedu-scratch/project/dmeerkerk/UI_Xray/json/train_likecoco_out_subset600_subset600.json \
...
--input_label_h5 /ceph/csedu-scratch/project/dmeerkerk/UI_Xray/train_out_label.h5  \
...
--checkpoint_path /ceph/csedu-scratch/project/dmeerkerk/UI_Xray/model/first_training_all_data/ \
--label_smoothing 0.0 \
--batch_size 1 \
--learning_rate 5e-4 \
--num_layers 6 \
...
#--start_from /ceph/csedu-scratch/project/dmeerkerk/UI_Xray/model/test_reloading_model/
