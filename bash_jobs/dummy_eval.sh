...
python eval.py \
        --dump_images 0 \
        --num_images -1 \
        --model /ceph/csedu-scratch/project/dmeerkerk/UI_Xray/model/dummy_02_dec/model-best.pth \
        --infos_path /ceph/csedu-scratch/project/dmeerkerk/UI_Xray/model/dummy_02_dec/infos_first_training_all_data-best.pkl \
