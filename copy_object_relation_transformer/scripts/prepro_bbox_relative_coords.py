...
def get_bbox_relative_coords(params):
    ...
    coco_ids_to_paths={str(''.join(filter(lambda i: i.isdigit(), imgpath))):imgpath.replace('pngCXR','png/CXR') for img in coco_dict for imgpath in img['images']}
    ...
    for ind, box_file in enumerate(box_files):
        ...
        try: 
            ...
            print('no such filenumber available: ', filenumber)
            continue
        try:
            img_array=get_numpy_image(img_path)
        except:
            print('no such file available: ', img_path)
            continue
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_json', type=str, 
                        default='/home/denise/Documents/Vakken/Scriptie/DATA/train_correct.json', 
                        help='input json file to process into hdf5')
    parser.add_argument('--image_root', type=str, default='',
                    help='In case the image paths have to be preprended with a root path to an image folder')
    parser.add_argument('--input_box_dir', type=str, 
                        default='/home/denise/Documents/Vakken/Scriptie/ScriptieRepo/object_relation_transformer/scripts/bu_out_box',
                    help='path to the directory containing the boxes of att feats')
    parser.add_argument('--output_dir', type=str, 
                        default='/home/denise/Documents/Vakken/Scriptie/ScriptieRepo/object_relation_transformer/scripts/bu_out_box_rel',
